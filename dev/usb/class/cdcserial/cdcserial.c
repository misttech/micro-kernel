...
void cdcserial_create_channel(cdcserial_channel_t *chan, int data_ep_addr, int ctrl_ep_addr) {
  ...
  ctrl_if_descriptor[LEADER_EP_NUMBER_OFFSET] = usb_get_current_iface_num_lowspeed();
  ctrl_if_descriptor[FOLLOWER_EP_NUMBER_OFFSET] = usb_get_current_iface_num_lowspeed() + 1;
  ...
  ctrl_if_descriptor[LEADER_EP_NUMBER_OFFSET] = usb_get_current_iface_num_highspeed();
  ctrl_if_descriptor[FOLLOWER_EP_NUMBER_OFFSET] = usb_get_current_iface_num_highspeed() + 1;
