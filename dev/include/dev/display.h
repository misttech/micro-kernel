...
status_t display_present(struct display_image *image, uint starty, uint endy) __NONNULL((1));
...
status_t display_get_framebuffer(struct display_framebuffer *fb) __NONNULL((1));
