...
static inline struct thread *arch_get_current_thread(void) { return riscv_get_current_thread(); }

static inline void arch_set_current_thread(struct thread *t) { riscv_set_current_thread(t); }
