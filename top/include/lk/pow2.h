...
static inline __ALWAYS_INLINE bool ispow2(uint val) { return ((val - 1) & val) == 0; }
...
static inline __ALWAYS_INLINE uint valpow2(uint valp2) { return 1U << valp2; }

static inline __ALWAYS_INLINE uint divpow2(uint val, uint divp2) { return val >> divp2; }
