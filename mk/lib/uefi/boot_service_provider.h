...
static constexpr auto EFI_DEVICE_PATH_PROTOCOL_GUID =
    EfiGuid{0x9576e91, 0x6d3f, 0x11d2, {0x8e, 0x39, 0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b}};

static constexpr auto LINUX_EFI_LOADED_IMAGE_FIXED_GUID =
    EfiGuid{0xf5a37b6d, 0x3344, 0x42a5, {0xb6, 0xbb, 0x97, 0x86, 0x48, 0xc1, 0x89, 0x0a}};
static constexpr auto EFI_RNG_PROTOCOL_GUID =
    EfiGuid{0x3152bca5, 0xeade, 0x433d, {0x86, 0x2e, 0xc0, 0x1c, 0xdc, 0x29, 0x1f, 0x44}};

static constexpr auto EFI_TCG2_PROTOCOL_GUID =
    EfiGuid{0x607f766c, 0x7455, 0x42be, {0x93, 0x0b, 0xe4, 0xd7, 0x6d, 0xb2, 0x72, 0x0f}};

static constexpr auto EFI_LOAD_FILE2_PROTOCOL_GUID =
    EfiGuid{0x4006c0c1, 0xfcb3, 0x403e, {0x99, 0x6d, 0x4a, 0x6c, 0x87, 0x24, 0xe0, 0x6d}};
static constexpr auto EFI_BLOCK_IO_PROTOCOL_GUID =
    EfiGuid{0x964e5b21, 0x6459, 0x11d2, {0x8e, 0x39, 0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b}};

static constexpr auto EFI_BLOCK_IO2_PROTOCOL_GUID =
    EfiGuid{0xa77b2472, 0xe282, 0x4e9f, {0xa2, 0x45, 0xc2, 0xc0, 0xe2, 0x7b, 0xbc, 0xc1}};

static constexpr auto EFI_TEXT_INPUT_PROTOCOL_GUID =
    EfiGuid{0x387477c1, 0x69c7, 0x11d2, {0x8e, 0x39, 0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b}};

static constexpr auto EFI_GBL_OS_CONFIGURATION_PROTOCOL_GUID =
    EfiGuid{0xdda0d135, 0xaa5b, 0x42ff, {0x85, 0xac, 0xe3, 0xad, 0x6e, 0xfb, 0x46, 0x19}};

static constexpr auto EFI_DT_FIXUP_PROTOCOL_GUID =
    EfiGuid{0xe617d64c, 0xfe08, 0x46da, {0xf4, 0xdc, 0xbb, 0xd5, 0x87, 0x0c, 0x73, 0x00}};
