...
#define DEFINE_REGISTER_TEST_CASE(case_name)              \
  ...
  void (*_register_##case_name##_ptr)(void) __SECTION(".ctors") = _register_##case_name;
...
static inline const char *unittest_get_msg(const char *arg) { return arg; }
#ifdef __cplusplus
static inline constexpr const char *unittest_get_msg() { return "<no message>"; }
#endif
 ...
 */
bool expect_bytes_eq(const uint8_t *expected, const uint8_t *actual, size_t len, const char *msg);
