...
void sbi_init(void) {
  ...
  if (LK_DEBUGLEVEL >= INFO) {
    ...
    if (sbi_ext_present(SBI_EXTENSION_TIMER))
      dprintf(INFO, "TIMER ");
    if (sbi_ext_present(SBI_EXTENSION_IPI))
      dprintf(INFO, "IPI ");
    if (sbi_ext_present(SBI_EXTENSION_RFENCE))
      dprintf(INFO, "RFENCE ");
    if (sbi_ext_present(SBI_EXTENSION_HSM))
      dprintf(INFO, "HSM ");
    if (sbi_ext_present(SBI_EXTENSION_SRST))
      dprintf(INFO, "SRST ");
    if (sbi_ext_present(SBI_EXTENSION_PMU))
      dprintf(INFO, "PMU ");
    if (sbi_ext_present(SBI_EXTENSION_DBCN))
      dprintf(INFO, "DBCN ");
    if (sbi_ext_present(SBI_EXTENSION_SUSP))
      dprintf(INFO, "SUSP ");
    if (sbi_ext_present(SBI_EXTENSION_CPPC))
      dprintf(INFO, "CPPC ");
    if (sbi_ext_present(SBI_EXTENSION_NACL))
      dprintf(INFO, "NACL ");
    if (sbi_ext_present(SBI_EXTENSION_STA))
      dprintf(INFO, "STA ");
    dprintf(INFO, "\n");
  }
}
