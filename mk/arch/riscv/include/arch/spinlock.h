...
static inline int arch_spin_trylock(spin_lock_t *lock) { return riscv_spin_trylock(lock); }

static inline void arch_spin_lock(spin_lock_t *lock) { riscv_spin_lock(lock); }

static inline void arch_spin_unlock(spin_lock_t *lock) { riscv_spin_unlock(lock); }
