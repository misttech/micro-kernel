...
If your arm64 platform is able to be served by a PM server (a.k.a. fx serve), then adding `//mk/arch/arm64/user-copy:benchmarks`
will be enough. If this is not the case, then adding `//mk/arch/arm64/user-copy:benchmarks-standalone` to your base labels
is enough.
