...
#ifndef MK_INCLUDE_KERNEL_DEBUG_H_
#define MK_INCLUDE_KERNEL_DEBUG_H_
...
#define KEVLOG_THREAD_SWITCH(from, to) \
  kernel_evlog_add(KERNEL_EVLOG_CONTEXT_SWITCH, (uintptr_t)from, (uintptr_t)to)
...
#define KEVLOG_TIMER_CALL(ptr, arg) \
  kernel_evlog_add(KERNEL_EVLOG_TIMER_CALL, (uintptr_t)ptr, (uintptr_t)arg)
...
#endif  // MK_INCLUDE_KERNEL_DEBUG_H_
