...
#ifndef MK_INCLUDE_ARCH_MMU_H_
#define MK_INCLUDE_ARCH_MMU_H_
...
#define ARCH_MMU_FLAG_UNCACHED_DEVICE                         \
...
vaddr_t arch_mmu_pick_spot(arch_aspace_t *aspace, vaddr_t base, uint prev_region_arch_mmu_flags,
                           vaddr_t end, uint next_region_arch_mmu_flags, vaddr_t align, size_t size,
                           uint arch_mmu_flags) __NONNULL((1));
