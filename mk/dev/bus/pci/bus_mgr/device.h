...
inline device::bar_sizes operator+(const device::bar_sizes &a, const device::bar_sizes &b) {
  ...
  result.prefetchable_align =
      (a.prefetchable_align > b.prefetchable_align) ? a.prefetchable_align : b.prefetchable_align;
  result.prefetchable64_align = (a.prefetchable64_align > b.prefetchable64_align)
                                    ? a.prefetchable64_align
                                    : b.prefetchable64_align;
...
inline device::bar_sizes &device::bar_sizes::operator+=(const device::bar_sizes &a) {
  ...
  prefetchable_align =
      (prefetchable_align > a.prefetchable_align) ? prefetchable_align : a.prefetchable_align;
  prefetchable64_align = (prefetchable64_align > a.prefetchable64_align) ? prefetchable64_align
                                                                         : a.prefetchable64_align;
