...
struct flag_labels gpio_flag_labels[] = {
    {GPIO_INPUT, "input"},       {GPIO_OUTPUT, "output"}, {GPIO_LEVEL, "level"},
    {GPIO_EDGE, "edge"},         {GPIO_RISING, "rising"}, {GPIO_FALLING, "falling"},
    {GPIO_HIGH, "high"},         {GPIO_LOW, "low"},       {GPIO_PULLUP, "pullup"},
