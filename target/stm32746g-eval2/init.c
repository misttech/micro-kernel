...
const sdram_config_t target_sdram_config = {.bus_width = SDRAM_BUS_WIDTH_32,
...
void HAL_ETH_MspInit(ETH_HandleTypeDef *heth) {
  ...
  */
  ...
  /* Note : ETH_MDIO is connected to PA2 which is shared with other signals like SAI2_SCKB.
     By default on STM32756G-EVAL board, PA2 is connected to SAI2_SCKB, so to connect PA2 to
    ETH_MDIO :
