...
#ifdef DEBUG_UART
#if DEBUG_UART == 1
  gpio_config(GPIO_USART1_TX, GPIO_STM32_AF | GPIO_STM32_AFn(GPIO_AF_USART1) | GPIO_PULLUP);
  gpio_config(GPIO_USART1_RX, GPIO_STM32_AF | GPIO_STM32_AFn(GPIO_AF_USART1) | GPIO_PULLUP);
#else  // !DEBUG_UART == 1
