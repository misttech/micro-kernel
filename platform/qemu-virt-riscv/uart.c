...
static inline uint8_t uart_read_8(size_t offset) { return uart_base[offset]; }

static inline void uart_write_8(size_t offset, uint8_t val) { uart_base[offset] = val; }
...
static int uart_getc(char *c, bool wait) { return cbuf_read_char(&uart_rx_buf, c, wait); }
