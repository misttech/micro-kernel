...
size_t call_with_stack_asm(void *stack, const void *function, void *param1, void *param2,
...
size_t call_with_stack(void *stack, Function &&fp, P1 &&param1, P2 &&param2, P3 &&param3,
                       P4 &&param4) {
...
size_t call_with_stack(void *stack, Function &&fp, P1 &&param1, P2 &&param2) {
  return call_with_stack_asm(stack, reinterpret_cast<const void *>(fp),
                             reinterpret_cast<void *>(param1), reinterpret_cast<void *>(param2), 0,
                             0);
}
#endif