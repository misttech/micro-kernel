...
static print_callback_t cb = {.entry = {0}, .print = gfxconsole_print_callback, .context = NULL};
...
static void gfxconsole_init_hook(uint level) { gfxconsole_start_on_display(); }
