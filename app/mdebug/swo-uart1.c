...
void swo_start_dma(void *ptr) {
  ...
  writel(0, DMA_LLI(0));
  writel(DMA_XFER_SIZE(TXNSIZE) | DMA_SRC_BURST(BURST_1) | DMA_DST_BURST(BURST_4) | DMA_SRC_BYTE |
             DMA_DST_WORD | DMA_SRC_MASTER1 | DMA_DST_MASTER0 | DMA_DST_INCR | DMA_PROT1 |
             DMA_TC_IE,
         DMA_CTL(0));
  writel(DMA_ENABLE | DMA_SRC_PERIPH(4) | DMA_FLOW_P2M_DMAc | DMA_TC_IRQ_EN, DMA_CFG(0));
}
