...
#define _LOGF(fmt, args...) printf("[%s:%d] " fmt, __PRETTY_FUNCTION__, __LINE__, ##args)
...
int v9p_tests(int argc, const console_cmd_args *argv) {
  ...
  virtio_9p_msg_t tatt = {.msg_type = P9_TATTACH,
                          .tag = P9_TAG_DEFAULT,
                          .msg.tattach = {.fid = FID_ROOT,
                                          .afid = P9_FID_NOFID,
                                          .uname = "root",
  ...
  virtio_9p_msg_t twalk = {
      .msg_type = P9_TWALK,
      .tag = P9_TAG_DEFAULT,
      .msg.twalk = {.fid = FID_ROOT, .newfid = FID_RO, .nwname = 1, .wname = {"LICENSE"}}};
  ...
  virtio_9p_msg_t tread = {.msg_type = P9_TREAD,
                           .tag = P9_TAG_DEFAULT,
                           .msg.tread = {.fid = FID_RO, .offset = 0, .count = 1024}};
